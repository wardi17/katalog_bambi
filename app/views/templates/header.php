...
<html lang="en">
  <head>
    ...
    <title>katalog bambi</title>


    <!-- Bootstrap core CSS -->
<link href="<?=base_url?>/assets/dist/css/navbar-top-fixed.css" rel="stylesheet">
